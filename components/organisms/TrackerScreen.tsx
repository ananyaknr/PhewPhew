  ...
  return (
    ...
    >
      ...
      <Box style={{ flex: 1, overflowY: "auto", padding: "0 20px 120px" }}>
        ...
        >
          <Text size={13} weight={700} style={{ marginBottom: 4 }}>
            Skin Score Trend
          </Text>
          <div
            style={{
              ...
              >
                <div
                  style={{
                    ...
                    background: activeMetric === i ? C.accent : C.accentLight,
                  }}
                />
                <Text size={8} color={C.muted}>
                  W{i + 1}
                </Text>
              </div>
            ))}
        ...
        >
          <Text size={13} weight={700} style={{ marginBottom: 12 }}>
            Metric Breakdown
          </Text>
          {[

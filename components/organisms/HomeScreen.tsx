...
export const HomeScreen: React.FC = () => {
  ...
  const allSteps = {
    AM: [
      {
        ...
        emoji: "🫧",
        why: "Removes overnight sebum without stripping your barrier — essential first step every AM.",
        tag: "Barrier Safe",
        tagColor: C.mintDark,
        tagBg: "#E8FFFB",
      },
      {
        ...
        brand: "COSRX AHA/BHA",
        emoji: "💧",
        why: "Preps skin pH before serums so actives absorb 40% better. Choose alcohol-free.",
        tag: "Prep Step",
        tagColor: "#1A6A88",
        tagBg: C.accentLight,
      },
      {
        ...
        brand: "Timeless 20% C+E",
        emoji: "🍊",
        why: "AM antioxidant that neutralises free radicals from PM2.5 — boosts SPF effectiveness.",
        tag: "✦ New",
        tagColor: C.premium,
        tagBg: C.premiumMid,
      },
      {
        name: "Moisturiser",
        brand: "Round Lab Birch",
        emoji: "🧴",
        why: "Seals in serum actives and maintains hydration throughout the day.",
        tag: "Locks In",
        tagColor: "#1A6A88",
        tagBg: C.accentLight,
      },
      {
        ...
        emoji: "☀️",
        why: "Non-negotiable last step — UV is the #1 cause of aging. Reapply every 2h outdoors.",
        tag: "Required",
        tagColor: "#7A6A00",
        tagBg: "#FFFDE8",
      },
    ...
    PM: [
      {
        name: "Oil Cleanser",
        brand: "Banila Co Clean It",
        emoji: "🫧",
        why: "First cleanse dissolves sunscreen and makeup. Essential for double-cleanse method.",
        tag: "Double Cleanse",
        tagColor: C.mintDark,
        tagBg: "#E8FFFB",
      },
      {
        ...
        brand: "CeraVe Foaming",
        emoji: "🧼",
        why: "Second cleanse clears remaining impurities — sets clean canvas for PM actives.",
        tag: "Deep Clean",
        tagColor: "#1A6A88",
        tagBg: C.accentLight,
      },
      {
        name: "BHA Toner",
        brand: "Paula's Choice 2%",
        emoji: "⚗️",
        why: "Unclogs pores and exfoliates dead skin while you sleep. Use 2–3x per week.",
        tag: "✦ New",
        tagColor: C.premium,
        tagBg: C.premiumMid,
      },
      {
        ...
        brand: "The Ordinary",
        emoji: "🔬",
        why: "Stimulates collagen overnight — the gold standard anti-aging ingredient. Start slow.",
        tag: "Anti-aging",
        tagColor: "#5A5000",
        tagBg: "#FFFDE8",
      },
      {
        ...
        brand: "Laneige Water Bank",
        emoji: "🌙",
        why: "Heavier PM formula that repairs and locks in moisture during sleep.",
        tag: "Repair Mode",
        tagColor: "#1A6A88",
        tagBg: C.accentLight,
      },
    ...
    >
      <Box style={{ flex: 1, overflowY: "auto", paddingBottom: 120 }}>
        ...
        <div
          style={{
            background:
              "linear-gradient(150deg, #D4F0FB 0%, #E8F8FF 50%, #E2F4FC 100%)",
            padding: "0 20px 18px",
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1, marginBottom: 14 }}>
            <Text
              size={11}
              color={C.sub}
              style={{ letterSpacing: "0.04em", marginBottom: 3 }}
            >
              Good morning, User ✦
            </Text>
            <Text
        ...
        <div style={{ padding: "14px 20px 0" }}>
          <div
            style={{
              ...
              cursor: "pointer",
              background:
                "linear-gradient(120deg, #0D3A50 0%, #1A6A7A 55%, #1A5040 100%)",
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      gap: 11,
                      padding: "11px 13px",
                      background: isExp ? "#F0F8FF" : "transparent",
                      cursor: "pointer",
                    }}
                  >
                    <div
        ...
        <div style={{ padding: "16px 20px 0" }}>
          ...
          >
            {[
              ...
              >
                <span style={{ fontSize: 22, color: a.iconColor }}>
                  {a.icon}
                </span>
                <Text size={12} weight={700} style={{ marginTop: 8 }}>
                  {a.label}
                </Text>
              </div>
            ))}
